...
//This file is a copy of jface's ActionContributionItem. It has been changed/hacked slighly
//to make a button / pull down toolbar item open the pulldown menu even when user
//clicks on the button icon.
//Changes are marked with comment HACK CHANGE
 ...
 */
public class ToolbarPulldownContributionItem extends ContributionItem {
	 ...
	 *            the action
	 */
	public ToolbarPulldownContributionItem(IAction action) {
		super(action.getId());
		this.action = action;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof ToolbarPulldownContributionItem)) {
			return false;
		}
		return action.equals(((ToolbarPulldownContributionItem) o).action);
	}
