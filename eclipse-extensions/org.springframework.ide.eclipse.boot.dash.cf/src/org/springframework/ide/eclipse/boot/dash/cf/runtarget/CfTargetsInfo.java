 ...
 *  Therefore this type should always match the one in the language server. For example, see the identical copy of this class in:
 *  org.springframework.ide.vscode.commons.cloudfoundry.client.cftarget.CfTargetsInfo
 *
 */
