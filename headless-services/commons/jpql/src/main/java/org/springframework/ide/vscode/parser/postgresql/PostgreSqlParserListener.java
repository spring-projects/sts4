...
public interface PostgreSqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PostgreSqlParser#top_clause}.
	 * @param ctx the parse tree
	 */
	void enterTop_clause(PostgreSqlParser.Top_clauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link PostgreSqlParser#top_clause}.
	 * @param ctx the parse tree
	 */
	void exitTop_clause(PostgreSqlParser.Top_clauseContext ctx);
	/**
