...
public class PostgreSqlLexer extends PostgreSqlLexerBase {
	...
	public static final int
		SPEL=1, Dollar=2, OPEN_PAREN=3, CLOSE_PAREN=4, OPEN_BRACKET=5, CLOSE_BRACKET=6, 
		COMMA=7, SEMI=8, COLON=9, QUESTION=10, STAR=11, EQUAL=12, DOT=13, PLUS=14, 
		MINUS=15, SLASH=16, CARET=17, LT=18, GT=19, LESS_LESS=20, GREATER_GREATER=21, 
		COLON_EQUALS=22, LESS_EQUALS=23, EQUALS_GREATER=24, GREATER_EQUALS=25, 
		DOT_DOT=26, NOT_EQUALS=27, TYPECAST=28, PERCENT=29, PARAM=30, Operator=31, 
		ALL=32, ANALYSE=33, ANALYZE=34, AND=35, ANY=36, ARRAY=37, AS=38, ASC=39, 
		ASYMMETRIC=40, BOTH=41, CASE=42, CAST=43, CHECK=44, COLLATE=45, COLUMN=46, 
		CONSTRAINT=47, CREATE=48, CURRENT_CATALOG=49, CURRENT_DATE=50, CURRENT_ROLE=51, 
		CURRENT_TIME=52, CURRENT_TIMESTAMP=53, CURRENT_USER=54, DEFAULT=55, DEFERRABLE=56, 
		DESC=57, DISTINCT=58, DO=59, ELSE=60, EXCEPT=61, FALSE_P=62, FETCH=63, 
		FOR=64, FOREIGN=65, FROM=66, GRANT=67, GROUP_P=68, HAVING=69, IN_P=70, 
		INITIALLY=71, INTERSECT=72, INTO=73, LATERAL_P=74, LEADING=75, LIMIT=76, 
		LOCALTIME=77, LOCALTIMESTAMP=78, NOT=79, NULL_P=80, OFFSET=81, ON=82, 
		ONLY=83, OR=84, ORDER=85, PLACING=86, PRIMARY=87, REFERENCES=88, RETURNING=89, 
		SELECT=90, SESSION_USER=91, SOME=92, SYMMETRIC=93, TABLE=94, THEN=95, 
		TO=96, TRAILING=97, TRUE_P=98, UNION=99, UNIQUE=100, USER=101, USING=102, 
		VARIADIC=103, WHEN=104, WHERE=105, WINDOW=106, WITH=107, AUTHORIZATION=108, 
		BINARY=109, COLLATION=110, CONCURRENTLY=111, CROSS=112, CURRENT_SCHEMA=113, 
		FREEZE=114, FULL=115, ILIKE=116, INNER_P=117, IS=118, ISNULL=119, JOIN=120, 
		LEFT=121, LIKE=122, NATURAL=123, NOTNULL=124, OUTER_P=125, OVER=126, OVERLAPS=127, 
		RIGHT=128, SIMILAR=129, VERBOSE=130, ABORT_P=131, ABSOLUTE_P=132, ACCESS=133, 
		ACTION=134, ADD_P=135, ADMIN=136, AFTER=137, AGGREGATE=138, ALSO=139, 
		ALTER=140, ALWAYS=141, ASSERTION=142, ASSIGNMENT=143, AT=144, ATTRIBUTE=145, 
		BACKWARD=146, BEFORE=147, BEGIN_P=148, BY=149, CACHE=150, CALLED=151, 
		CASCADE=152, CASCADED=153, CATALOG=154, CHAIN=155, CHARACTERISTICS=156, 
		CHECKPOINT=157, CLASS=158, CLOSE=159, CLUSTER=160, COMMENT=161, COMMENTS=162, 
		COMMIT=163, COMMITTED=164, CONFIGURATION=165, CONNECTION=166, CONSTRAINTS=167, 
		CONTENT_P=168, CONTINUE_P=169, CONVERSION_P=170, COPY=171, COST=172, CSV=173, 
		CURSOR=174, CYCLE=175, DATA_P=176, DATABASE=177, DAY_P=178, DEALLOCATE=179, 
		DECLARE=180, DEFAULTS=181, DEFERRED=182, DEFINER=183, DELETE_P=184, DELIMITER=185, 
		DELIMITERS=186, DICTIONARY=187, DISABLE_P=188, DISCARD=189, DOCUMENT_P=190, 
		DOMAIN_P=191, DOUBLE_P=192, DROP=193, EACH=194, ENABLE_P=195, ENCODING=196, 
		ENCRYPTED=197, ENUM_P=198, ESCAPE=199, EVENT=200, EXCLUDE=201, EXCLUDING=202, 
		EXCLUSIVE=203, EXECUTE=204, EXPLAIN=205, EXTENSION=206, EXTERNAL=207, 
		FAMILY=208, FIRST_P=209, FOLLOWING=210, FORCE=211, FORWARD=212, FUNCTION=213, 
		FUNCTIONS=214, GLOBAL=215, GRANTED=216, HANDLER=217, HEADER_P=218, HOLD=219, 
		HOUR_P=220, IDENTITY_P=221, IF_P=222, IMMEDIATE=223, IMMUTABLE=224, IMPLICIT_P=225, 
		INCLUDING=226, INCREMENT=227, INDEX=228, INDEXES=229, INHERIT=230, INHERITS=231, 
		INLINE_P=232, INSENSITIVE=233, INSERT=234, INSTEAD=235, INVOKER=236, ISOLATION=237, 
		KEY=238, LABEL=239, LANGUAGE=240, LARGE_P=241, LAST_P=242, LEAKPROOF=243, 
		LEVEL=244, LISTEN=245, LOAD=246, LOCAL=247, LOCATION=248, LOCK_P=249, 
		MAPPING=250, MATCH=251, MATCHED=252, MATERIALIZED=253, MAXVALUE=254, MERGE=255, 
		MINUTE_P=256, MINVALUE=257, MODE=258, MONTH_P=259, MOVE=260, NAME_P=261, 
		NAMES=262, NEXT=263, NO=264, NOTHING=265, NOTIFY=266, NOWAIT=267, NULLS_P=268, 
		OBJECT_P=269, OF=270, OFF=271, OIDS=272, OPERATOR=273, OPTION=274, OPTIONS=275, 
		OWNED=276, OWNER=277, PARSER=278, PARTIAL=279, PARTITION=280, PASSING=281, 
		PASSWORD=282, PLANS=283, PRECEDING=284, PREPARE=285, PREPARED=286, PRESERVE=287, 
		PRIOR=288, PRIVILEGES=289, PROCEDURAL=290, PROCEDURE=291, PROGRAM=292, 
		QUOTE=293, RANGE=294, READ=295, REASSIGN=296, RECHECK=297, RECURSIVE=298, 
		REF=299, REFRESH=300, REINDEX=301, RELATIVE_P=302, RELEASE=303, RENAME=304, 
		REPEATABLE=305, REPLACE=306, REPLICA=307, RESET=308, RESTART=309, RESTRICT=310, 
		RETURNS=311, REVOKE=312, ROLE=313, ROLLBACK=314, ROWS=315, RULE=316, SAVEPOINT=317, 
		SCHEMA=318, SCROLL=319, SEARCH=320, SECOND_P=321, SECURITY=322, SEQUENCE=323, 
		SEQUENCES=324, SERIALIZABLE=325, SERVER=326, SESSION=327, SET=328, SHARE=329, 
		SHOW=330, SIMPLE=331, SNAPSHOT=332, STABLE=333, STANDALONE_P=334, START=335, 
		STATEMENT=336, STATISTICS=337, STDIN=338, STDOUT=339, STORAGE=340, STRICT_P=341, 
		STRIP_P=342, SYSID=343, SYSTEM_P=344, TABLES=345, TABLESPACE=346, TEMP=347, 
		TEMPLATE=348, TEMPORARY=349, TEXT_P=350, TRANSACTION=351, TRIGGER=352, 
		TRUNCATE=353, TRUSTED=354, TYPE_P=355, TYPES_P=356, UNBOUNDED=357, UNCOMMITTED=358, 
		UNENCRYPTED=359, UNKNOWN=360, UNLISTEN=361, UNLOGGED=362, UNTIL=363, UPDATE=364, 
		VACUUM=365, VALID=366, VALIDATE=367, VALIDATOR=368, VARYING=369, VERSION_P=370, 
		VIEW=371, VOLATILE=372, WHITESPACE_P=373, WITHOUT=374, WORK=375, WRAPPER=376, 
		WRITE=377, XML_P=378, YEAR_P=379, YES_P=380, ZONE=381, BETWEEN=382, BIGINT=383, 
		BIT=384, BOOLEAN_P=385, CHAR_P=386, CHARACTER=387, COALESCE=388, DEC=389, 
		DECIMAL_P=390, EXISTS=391, EXTRACT=392, FLOAT_P=393, GREATEST=394, INOUT=395, 
		INT_P=396, INTEGER=397, INTERVAL=398, LEAST=399, NATIONAL=400, NCHAR=401, 
		NONE=402, NULLIF=403, NUMERIC=404, OVERLAY=405, POSITION=406, PRECISION=407, 
		REAL=408, ROW=409, SETOF=410, SMALLINT=411, SUBSTRING=412, TIME=413, TIMESTAMP=414, 
		TREAT=415, TRIM=416, VALUES=417, VARCHAR=418, XMLATTRIBUTES=419, XMLCOMMENT=420, 
		XMLAGG=421, XML_IS_WELL_FORMED=422, XML_IS_WELL_FORMED_DOCUMENT=423, XML_IS_WELL_FORMED_CONTENT=424, 
		XPATH=425, XPATH_EXISTS=426, XMLCONCAT=427, XMLELEMENT=428, XMLEXISTS=429, 
		XMLFOREST=430, XMLPARSE=431, XMLPI=432, XMLROOT=433, XMLSERIALIZE=434, 
		CALL=435, CURRENT_P=436, ATTACH=437, DETACH=438, EXPRESSION=439, GENERATED=440, 
		LOGGED=441, STORED=442, INCLUDE=443, ROUTINE=444, TRANSFORM=445, IMPORT_P=446, 
		POLICY=447, METHOD=448, REFERENCING=449, NEW=450, OLD=451, VALUE_P=452, 
		SUBSCRIPTION=453, PUBLICATION=454, OUT_P=455, END_P=456, ROUTINES=457, 
		SCHEMAS=458, PROCEDURES=459, INPUT_P=460, SUPPORT=461, PARALLEL=462, SQL_P=463, 
		DEPENDS=464, OVERRIDING=465, CONFLICT=466, SKIP_P=467, LOCKED=468, TIES=469, 
		ROLLUP=470, CUBE=471, GROUPING=472, SETS=473, TABLESAMPLE=474, ORDINALITY=475, 
		XMLTABLE=476, COLUMNS=477, XMLNAMESPACES=478, ROWTYPE=479, NORMALIZED=480, 
		WITHIN=481, FILTER=482, GROUPS=483, OTHERS=484, NFC=485, NFD=486, NFKC=487, 
		NFKD=488, UESCAPE=489, VIEWS=490, NORMALIZE=491, DUMP=492, PRINT_STRICT_PARAMS=493, 
		VARIABLE_CONFLICT=494, ERROR=495, USE_VARIABLE=496, USE_COLUMN=497, ALIAS=498, 
		CONSTANT=499, PERFORM=500, GET=501, DIAGNOSTICS=502, STACKED=503, ELSIF=504, 
		WHILE=505, REVERSE=506, FOREACH=507, SLICE=508, EXIT=509, RETURN=510, 
		QUERY=511, RAISE=512, SQLSTATE=513, DEBUG=514, LOG=515, INFO=516, NOTICE=517, 
		WARNING=518, EXCEPTION=519, ASSERT=520, LOOP=521, OPEN=522, TOP=523, ABS=524, 
		CBRT=525, CEIL=526, CEILING=527, DEGREES=528, DIV=529, EXP=530, FACTORIAL=531, 
		FLOOR=532, GCD=533, LCM=534, LN=535, LOG10=536, MIN_SCALE=537, MOD=538, 
		PI=539, POWER=540, RADIANS=541, ROUND=542, SCALE=543, SIGN=544, SQRT=545, 
		TRIM_SCALE=546, TRUNC=547, WIDTH_BUCKET=548, RANDOM=549, SETSEED=550, 
		ACOS=551, ACOSD=552, ASIN=553, ASIND=554, ATAN=555, ATAND=556, ATAN2=557, 
		ATAN2D=558, COS=559, COSD=560, COT=561, COTD=562, SIN=563, SIND=564, TAN=565, 
		TAND=566, SINH=567, COSH=568, TANH=569, ASINH=570, ACOSH=571, ATANH=572, 
		BIT_LENGTH=573, CHAR_LENGTH=574, CHARACTER_LENGTH=575, LOWER=576, OCTET_LENGTH=577, 
		UPPER=578, ASCII=579, BTRIM=580, CHR=581, CONCAT=582, CONCAT_WS=583, FORMAT=584, 
		INITCAP=585, LENGTH=586, LPAD=587, LTRIM=588, MD5=589, PARSE_IDENT=590, 
		PG_CLIENT_ENCODING=591, QUOTE_IDENT=592, QUOTE_LITERAL=593, QUOTE_NULLABLE=594, 
		REGEXP_COUNT=595, REGEXP_INSTR=596, REGEXP_LIKE=597, REGEXP_MATCH=598, 
		REGEXP_MATCHES=599, REGEXP_REPLACE=600, REGEXP_SPLIT_TO_ARRAY=601, REGEXP_SPLIT_TO_TABLE=602, 
		REGEXP_SUBSTR=603, REPEAT=604, RPAD=605, RTRIM=606, SPLIT_PART=607, STARTS_WITH=608, 
		STRING_TO_ARRAY=609, STRING_TO_TABLE=610, STRPOS=611, SUBSTR=612, TO_ASCII=613, 
		TO_HEX=614, TRANSLATE=615, UNISTR=616, AGE=617, CLOCK_TIMESTAMP=618, DATE_BIN=619, 
		DATE_PART=620, DATE_TRUNC=621, ISFINITE=622, JUSTIFY_DAYS=623, JUSTIFY_HOURS=624, 
		JUSTIFY_INTERVAL=625, MAKE_DATE=626, MAKE_INTERVAL=627, MAKE_TIME=628, 
		MAKE_TIMESTAMP=629, MAKE_TIMESTAMPTZ=630, NOW=631, STATEMENT_TIMESTAMP=632, 
		TIMEOFDAY=633, TRANSACTION_TIMESTAMP=634, TO_TIMESTAMP=635, TO_CHAR=636, 
		TO_DATE=637, TO_NUMBER=638, Identifier=639, QuotedIdentifier=640, UnterminatedQuotedIdentifier=641, 
		InvalidQuotedIdentifier=642, InvalidUnterminatedQuotedIdentifier=643, 
		UnicodeQuotedIdentifier=644, UnterminatedUnicodeQuotedIdentifier=645, 
		InvalidUnicodeQuotedIdentifier=646, InvalidUnterminatedUnicodeQuotedIdentifier=647, 
		StringConstant=648, UnterminatedStringConstant=649, UnicodeEscapeStringConstant=650, 
		UnterminatedUnicodeEscapeStringConstant=651, BeginDollarStringConstant=652, 
		BinaryStringConstant=653, UnterminatedBinaryStringConstant=654, InvalidBinaryStringConstant=655, 
		InvalidUnterminatedBinaryStringConstant=656, HexadecimalStringConstant=657, 
		UnterminatedHexadecimalStringConstant=658, InvalidHexadecimalStringConstant=659, 
		InvalidUnterminatedHexadecimalStringConstant=660, Integral=661, NumericFail=662, 
		Numeric=663, PLSQLIDENTIFIER=664, Whitespace=665, Newline=666, LineComment=667, 
		BlockComment=668, UnterminatedBlockComment=669, MetaCommand=670, EndMetaCommand=671, 
		ErrorCharacter=672, EscapeStringConstant=673, UnterminatedEscapeStringConstant=674, 
		InvalidEscapeStringConstant=675, InvalidUnterminatedEscapeStringConstant=676, 
		DollarText=677, EndDollarStringConstant=678, AfterEscapeStringConstantWithNewlineMode_Continued=679;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SPEL", "ANYTHING", "Dollar", "OPEN_PAREN", "CLOSE_PAREN", "OPEN_BRACKET", 
			"CLOSE_BRACKET", "COMMA", "SEMI", "COLON", "QUESTION", "STAR", "EQUAL", 
			"DOT", "PLUS", "MINUS", "SLASH", "CARET", "LT", "GT", "LESS_LESS", "GREATER_GREATER", 
			...
			"NOTICE", "WARNING", "EXCEPTION", "ASSERT", "LOOP", "OPEN", "TOP", "ABS", 
			...
			"Integral", "NumericFail", "Numeric", "Digits", "PLSQLIDENTIFIER", "Whitespace", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'LOOP'", "'OPEN'", "'TOP'", "'ABS'", "'CBRT'", "'CEIL'", "'CEILING'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "SPEL", "Dollar", "OPEN_PAREN", "CLOSE_PAREN", "OPEN_BRACKET", 
			"CLOSE_BRACKET", "COMMA", "SEMI", "COLON", "QUESTION", "STAR", "EQUAL", 
			"DOT", "PLUS", "MINUS", "SLASH", "CARET", "LT", "GT", "LESS_LESS", "GREATER_GREATER", 
			"COLON_EQUALS", "LESS_EQUALS", "EQUALS_GREATER", "GREATER_EQUALS", "DOT_DOT", 
			...
			"HexadecimalStringConstant", "UnterminatedHexadecimalStringConstant", 
			"InvalidHexadecimalStringConstant", "InvalidUnterminatedHexadecimalStringConstant", 
			"Integral", "NumericFail", "Numeric", "PLSQLIDENTIFIER", "Whitespace", 
			"Newline", "LineComment", "BlockComment", "UnterminatedBlockComment", 
			"MetaCommand", "EndMetaCommand", "ErrorCharacter", "EscapeStringConstant", 
	...
	private static final String _serializedATNSegment0 =
		...
		"\u0011)\u0012+\u0013-\u0014/\u00151\u00163\u00175\u00187\u00199\u001a"+
		";\u001b=\u001c?\u001dA\u001eC\u001fE\u0000G\u0000I\u0000K\u0000M O!Q\""+
		"S#U$W%Y&[\'](_)a*c+e,g-i.k/m0o1q2s3u4w5y6{7}8\u007f9\u0081:\u0083;\u0085"+
		"<\u0087=\u0089>\u008b?\u008d@\u008fA\u0091B\u0093C\u0095D\u0097E\u0099"+
		"F\u009bG\u009dH\u009fI\u00a1J\u00a3K\u00a5L\u00a7M\u00a9N\u00abO\u00ad"+
		...
		"^^``||~~\u0002\u0000*+<>\b\u0000!!##%&@@^^``||~~\u0002\u0000AAaa\u0002"+
		"\u0000LLll\u0002\u0000NNnn\u0002\u0000YYyy\u0002\u0000SSss\u0002\u0000"+
		"EEee\u0002\u0000ZZzz\u0002\u0000DDdd\u0002\u0000RRrr\u0002\u0000CCcc\u0002"+
		"\u0000MMmm\u0002\u0000TTtt\u0002\u0000IIii\u0002\u0000BBbb\u0002\u0000"+
		"OOoo\u0002\u0000HHhh\u0002\u0000KKkk\u0002\u0000UUuu\u0002\u0000GGgg\u0002"+
		"\u0000PPpp\u0002\u0000FFff\u0002\u0000XXxx\u0002\u0000VVvv\u0002\u0000"+
		"QQqq\u0002\u0000WWww\u0002\u0000JJjj\t\u0000AZ__az\u00aa\u00aa\u00b5\u00b5"+
		"\u00ba\u00ba\u00c0\u00d6\u00d8\u00f6\u00f8\u00ff\u0002\u0000\u0100\u8000"+
		"\ud7ff\u8000\ue000\u8000\uffff\u0001\u0000\u8000\ud800\u8000\udbff\u0001"+
		"\u0000\u8000\udc00\u8000\udfff\u0002\u0000\u0000\u0000\"\"\u0001\u0000"+
		"\"\"\u0001\u0000\'\'\u0001\u000001\u0003\u000009AFaf\u0002\u0000\"\"\\"+
