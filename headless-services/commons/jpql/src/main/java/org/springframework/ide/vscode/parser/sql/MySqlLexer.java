...
public class MySqlLexer extends Lexer {
	...
	public static final int
		SPEL=1, SPACE=2, SPEC_MYSQL_COMMENT=3, COMMENT_INPUT=4, LINE_COMMENT=5, 
		ADD=6, ALL=7, ALTER=8, ALWAYS=9, ANALYZE=10, AND=11, ARRAY=12, AS=13, 
		ASC=14, ATTRIBUTE=15, BEFORE=16, BETWEEN=17, BOTH=18, BUCKETS=19, BY=20, 
		...
		GRANT=73, GROUP=74, HAVING=75, HIGH_PRIORITY=76, HISTOGRAM=77, IF=78, 
		IGNORE=79, IGNORED=80, IN=81, INDEX=82, INFILE=83, INNER=84, INOUT=85, 
		INSERT=86, INTERVAL=87, INTO=88, IS=89, ITERATE=90, JOIN=91, KEY=92, KEYS=93, 
		KILL=94, LATERAL=95, LEADING=96, LEAVE=97, LEFT=98, LIKE=99, LIMIT=100, 
		LINEAR=101, LINES=102, LOAD=103, LOCK=104, LOCKED=105, LOOP=106, LOW_PRIORITY=107, 
		MASTER_BIND=108, MASTER_SSL_VERIFY_SERVER_CERT=109, MATCH=110, MAXVALUE=111, 
		MINVALUE=112, MODIFIES=113, NATURAL=114, NOT=115, NO_WRITE_TO_BINLOG=116, 
		NULL_LITERAL=117, NUMBER=118, ON=119, OPTIMIZE=120, OPTION=121, OPTIONAL=122, 
		OPTIONALLY=123, OR=124, ORDER=125, OUT=126, OUTER=127, OUTFILE=128, OVER=129, 
		PARTITION=130, PRIMARY=131, PROCEDURE=132, PURGE=133, RANGE=134, READ=135, 
		READS=136, REFERENCES=137, REGEXP=138, RELEASE=139, RENAME=140, REPEAT=141, 
		REPLACE=142, REQUIRE=143, RESIGNAL=144, RESTRICT=145, RETAIN=146, RETURN=147, 
		REVOKE=148, RIGHT=149, RLIKE=150, SCHEMA=151, SCHEMAS=152, SELECT=153, 
		SET=154, SEPARATOR=155, SHOW=156, SIGNAL=157, SKIP_=158, SKIP_QUERY_REWRITE=159, 
		SPATIAL=160, SQL=161, SQLEXCEPTION=162, SQLSTATE=163, SQLWARNING=164, 
		SQL_BIG_RESULT=165, SQL_CALC_FOUND_ROWS=166, SQL_SMALL_RESULT=167, SSL=168, 
		STACKED=169, STARTING=170, STATEMENT=171, STRAIGHT_JOIN=172, TABLE=173, 
		TERMINATED=174, THEN=175, TO=176, TRAILING=177, TRIGGER=178, TRUE=179, 
		UNDO=180, UNION=181, UNIQUE=182, UNLOCK=183, UNSIGNED=184, UPDATE=185, 
		USAGE=186, USE=187, USING=188, VALUES=189, WHEN=190, WHERE=191, WHILE=192, 
		WITH=193, WRITE=194, XOR=195, ZEROFILL=196, TINYINT=197, SMALLINT=198, 
		MEDIUMINT=199, MIDDLEINT=200, INT=201, INT1=202, INT2=203, INT3=204, INT4=205, 
		INT8=206, INTEGER=207, BIGINT=208, REAL=209, DOUBLE=210, PRECISION=211, 
		FLOAT=212, FLOAT4=213, FLOAT8=214, DECIMAL=215, DEC=216, NUMERIC=217, 
		DATE=218, TIME=219, TIMESTAMP=220, DATETIME=221, YEAR=222, CHAR=223, VARCHAR=224, 
		NVARCHAR=225, NATIONAL=226, BINARY=227, VARBINARY=228, TINYBLOB=229, BLOB=230, 
		MEDIUMBLOB=231, LONG=232, LONGBLOB=233, TINYTEXT=234, TEXT=235, MEDIUMTEXT=236, 
		LONGTEXT=237, ENUM=238, VARYING=239, SERIAL=240, YEAR_MONTH=241, DAY_HOUR=242, 
		DAY_MINUTE=243, DAY_SECOND=244, HOUR_MINUTE=245, HOUR_SECOND=246, MINUTE_SECOND=247, 
		SECOND_MICROSECOND=248, MINUTE_MICROSECOND=249, HOUR_MICROSECOND=250, 
		...
		ADMIN=698, APPLICATION_PASSWORD_ADMIN=699, AUDIT_ABORT_EXEMPT=700, AUDIT_ADMIN=701, 
		AUTHENTICATION_POLICY_ADMIN=702, BACKUP_ADMIN=703, BINLOG_ADMIN=704, BINLOG_ENCRYPTION_ADMIN=705, 
		CLONE_ADMIN=706, CONNECTION_ADMIN=707, ENCRYPTION_KEY_ADMIN=708, EXECUTE=709, 
		FILE=710, FIREWALL_ADMIN=711, FIREWALL_EXEMPT=712, FIREWALL_USER=713, 
		FLUSH_OPTIMIZER_COSTS=714, FLUSH_STATUS=715, FLUSH_TABLES=716, FLUSH_USER_RESOURCES=717, 
		GROUP_REPLICATION_ADMIN=718, INNODB_REDO_LOG_ARCHIVE=719, INNODB_REDO_LOG_ENABLE=720, 
		INVOKE=721, LAMBDA=722, NDB_STORED_USER=723, PASSWORDLESS_USER_ADMIN=724, 
		PERSIST_RO_VARIABLES_ADMIN=725, PRIVILEGES=726, PROCESS=727, RELOAD=728, 
		REPLICATION_APPLIER=729, REPLICATION_SLAVE_ADMIN=730, RESOURCE_GROUP_ADMIN=731, 
		RESOURCE_GROUP_USER=732, ROLE_ADMIN=733, ROUTINE=734, S3=735, SERVICE_CONNECTION_ADMIN=736, 
		SESSION_VARIABLES_ADMIN=737, SET_USER_ID=738, SHOW_ROUTINE=739, SHUTDOWN=740, 
		SUPER=741, SYSTEM_VARIABLES_ADMIN=742, TABLES=743, TABLE_ENCRYPTION_ADMIN=744, 
		VERSION_TOKEN_ADMIN=745, XA_RECOVER_ADMIN=746, ARMSCII8=747, ASCII=748, 
		BIG5=749, CP1250=750, CP1251=751, CP1256=752, CP1257=753, CP850=754, CP852=755, 
		CP866=756, CP932=757, DEC8=758, EUCJPMS=759, EUCKR=760, GB18030=761, GB2312=762, 
		GBK=763, GEOSTD8=764, GREEK=765, HEBREW=766, HP8=767, KEYBCS2=768, KOI8R=769, 
		KOI8U=770, LATIN1=771, LATIN2=772, LATIN5=773, LATIN7=774, MACCE=775, 
		MACROMAN=776, SJIS=777, SWE7=778, TIS620=779, UCS2=780, UJIS=781, UTF16=782, 
		UTF16LE=783, UTF32=784, UTF8=785, UTF8MB3=786, UTF8MB4=787, ARCHIVE=788, 
		BLACKHOLE=789, CSV=790, FEDERATED=791, INNODB=792, MEMORY=793, MRG_MYISAM=794, 
		MYISAM=795, NDB=796, NDBCLUSTER=797, PERFORMANCE_SCHEMA=798, TOKUDB=799, 
		REPEATABLE=800, COMMITTED=801, UNCOMMITTED=802, SERIALIZABLE=803, GEOMETRYCOLLECTION=804, 
		GEOMCOLLECTION=805, GEOMETRY=806, LINESTRING=807, MULTILINESTRING=808, 
		MULTIPOINT=809, MULTIPOLYGON=810, POINT=811, POLYGON=812, ABS=813, ACOS=814, 
		ADDDATE=815, ADDTIME=816, AES_DECRYPT=817, AES_ENCRYPT=818, AREA=819, 
		ASBINARY=820, ASIN=821, ASTEXT=822, ASWKB=823, ASWKT=824, ASYMMETRIC_DECRYPT=825, 
		ASYMMETRIC_DERIVE=826, ASYMMETRIC_ENCRYPT=827, ASYMMETRIC_SIGN=828, ASYMMETRIC_VERIFY=829, 
		ATAN=830, ATAN2=831, BENCHMARK=832, BIN=833, BIT_COUNT=834, BIT_LENGTH=835, 
		BUFFER=836, CATALOG_NAME=837, CEIL=838, CEILING=839, CENTROID=840, CHARACTER_LENGTH=841, 
		CHARSET=842, CHAR_LENGTH=843, COERCIBILITY=844, COLLATION=845, COMPRESS=846, 
		CONCAT=847, CONCAT_WS=848, CONNECTION_ID=849, CONV=850, CONVERT_TZ=851, 
		COS=852, COT=853, CRC32=854, CREATE_ASYMMETRIC_PRIV_KEY=855, CREATE_ASYMMETRIC_PUB_KEY=856, 
		CREATE_DH_PARAMETERS=857, CREATE_DIGEST=858, CROSSES=859, DATEDIFF=860, 
		DATE_FORMAT=861, DAYNAME=862, DAYOFMONTH=863, DAYOFWEEK=864, DAYOFYEAR=865, 
		DECODE=866, DEGREES=867, DES_DECRYPT=868, DES_ENCRYPT=869, DIMENSION=870, 
		DISJOINT=871, ELT=872, ENCODE=873, ENCRYPT=874, ENDPOINT=875, ENGINE_ATTRIBUTE=876, 
		ENVELOPE=877, EQUALS=878, EXP=879, EXPORT_SET=880, EXTERIORRING=881, EXTRACTVALUE=882, 
		FIELD=883, FIND_IN_SET=884, FLOOR=885, FORMAT=886, FOUND_ROWS=887, FROM_BASE64=888, 
		FROM_DAYS=889, FROM_UNIXTIME=890, GEOMCOLLFROMTEXT=891, GEOMCOLLFROMWKB=892, 
		GEOMETRYCOLLECTIONFROMTEXT=893, GEOMETRYCOLLECTIONFROMWKB=894, GEOMETRYFROMTEXT=895, 
		GEOMETRYFROMWKB=896, GEOMETRYN=897, GEOMETRYTYPE=898, GEOMFROMTEXT=899, 
		GEOMFROMWKB=900, GET_FORMAT=901, GET_LOCK=902, GLENGTH=903, GREATEST=904, 
		GTID_SUBSET=905, GTID_SUBTRACT=906, HEX=907, IFNULL=908, INET6_ATON=909, 
		INET6_NTOA=910, INET_ATON=911, INET_NTOA=912, INSTR=913, INTERIORRINGN=914, 
		INTERSECTS=915, ISCLOSED=916, ISEMPTY=917, ISNULL=918, ISSIMPLE=919, IS_FREE_LOCK=920, 
		IS_IPV4=921, IS_IPV4_COMPAT=922, IS_IPV4_MAPPED=923, IS_IPV6=924, IS_USED_LOCK=925, 
		LAST_INSERT_ID=926, LCASE=927, LEAST=928, LENGTH=929, LINEFROMTEXT=930, 
		LINEFROMWKB=931, LINESTRINGFROMTEXT=932, LINESTRINGFROMWKB=933, LN=934, 
		LOAD_FILE=935, LOCATE=936, LOG=937, LOG10=938, LOG2=939, LOWER=940, LPAD=941, 
		LTRIM=942, MAKEDATE=943, MAKETIME=944, MAKE_SET=945, MASTER_POS_WAIT=946, 
		MBRCONTAINS=947, MBRDISJOINT=948, MBREQUAL=949, MBRINTERSECTS=950, MBROVERLAPS=951, 
		MBRTOUCHES=952, MBRWITHIN=953, MD5=954, MLINEFROMTEXT=955, MLINEFROMWKB=956, 
		MONTHNAME=957, MPOINTFROMTEXT=958, MPOINTFROMWKB=959, MPOLYFROMTEXT=960, 
		MPOLYFROMWKB=961, MULTILINESTRINGFROMTEXT=962, MULTILINESTRINGFROMWKB=963, 
		MULTIPOINTFROMTEXT=964, MULTIPOINTFROMWKB=965, MULTIPOLYGONFROMTEXT=966, 
		MULTIPOLYGONFROMWKB=967, NAME_CONST=968, NULLIF=969, NUMGEOMETRIES=970, 
		NUMINTERIORRINGS=971, NUMPOINTS=972, OCT=973, OCTET_LENGTH=974, ORD=975, 
		OVERLAPS=976, PERIOD_ADD=977, PERIOD_DIFF=978, PI=979, POINTFROMTEXT=980, 
		POINTFROMWKB=981, POINTN=982, POLYFROMTEXT=983, POLYFROMWKB=984, POLYGONFROMTEXT=985, 
		POLYGONFROMWKB=986, POW=987, POWER=988, QUOTE=989, RADIANS=990, RAND=991, 
		RANDOM=992, RANDOM_BYTES=993, RELEASE_LOCK=994, REVERSE=995, ROUND=996, 
		ROW_COUNT=997, RPAD=998, RTRIM=999, SEC_TO_TIME=1000, SECONDARY_ENGINE_ATTRIBUTE=1001, 
		SESSION_USER=1002, SHA=1003, SHA1=1004, SHA2=1005, SCHEMA_NAME=1006, SIGN=1007, 
		SIN=1008, SLEEP=1009, SOUNDEX=1010, SQL_THREAD_WAIT_AFTER_GTIDS=1011, 
		SQRT=1012, SRID=1013, STARTPOINT=1014, STRCMP=1015, STR_TO_DATE=1016, 
		ST_AREA=1017, ST_ASBINARY=1018, ST_ASTEXT=1019, ST_ASWKB=1020, ST_ASWKT=1021, 
		ST_BUFFER=1022, ST_CENTROID=1023, ST_CONTAINS=1024, ST_CROSSES=1025, ST_DIFFERENCE=1026, 
		ST_DIMENSION=1027, ST_DISJOINT=1028, ST_DISTANCE=1029, ST_ENDPOINT=1030, 
		ST_ENVELOPE=1031, ST_EQUALS=1032, ST_EXTERIORRING=1033, ST_GEOMCOLLFROMTEXT=1034, 
		ST_GEOMCOLLFROMTXT=1035, ST_GEOMCOLLFROMWKB=1036, ST_GEOMETRYCOLLECTIONFROMTEXT=1037, 
		ST_GEOMETRYCOLLECTIONFROMWKB=1038, ST_GEOMETRYFROMTEXT=1039, ST_GEOMETRYFROMWKB=1040, 
		ST_GEOMETRYN=1041, ST_GEOMETRYTYPE=1042, ST_GEOMFROMTEXT=1043, ST_GEOMFROMWKB=1044, 
		ST_INTERIORRINGN=1045, ST_INTERSECTION=1046, ST_INTERSECTS=1047, ST_ISCLOSED=1048, 
		ST_ISEMPTY=1049, ST_ISSIMPLE=1050, ST_LINEFROMTEXT=1051, ST_LINEFROMWKB=1052, 
		ST_LINESTRINGFROMTEXT=1053, ST_LINESTRINGFROMWKB=1054, ST_NUMGEOMETRIES=1055, 
		ST_NUMINTERIORRING=1056, ST_NUMINTERIORRINGS=1057, ST_NUMPOINTS=1058, 
		ST_OVERLAPS=1059, ST_POINTFROMTEXT=1060, ST_POINTFROMWKB=1061, ST_POINTN=1062, 
		ST_POLYFROMTEXT=1063, ST_POLYFROMWKB=1064, ST_POLYGONFROMTEXT=1065, ST_POLYGONFROMWKB=1066, 
		ST_SRID=1067, ST_STARTPOINT=1068, ST_SYMDIFFERENCE=1069, ST_TOUCHES=1070, 
		ST_UNION=1071, ST_WITHIN=1072, ST_X=1073, ST_Y=1074, SUBDATE=1075, SUBSTRING_INDEX=1076, 
		SUBTIME=1077, SYSTEM_USER=1078, TAN=1079, TIMEDIFF=1080, TIMESTAMPADD=1081, 
		TIMESTAMPDIFF=1082, TIME_FORMAT=1083, TIME_TO_SEC=1084, TOUCHES=1085, 
		TO_BASE64=1086, TO_DAYS=1087, TO_SECONDS=1088, TP_CONNECTION_ADMIN=1089, 
		UCASE=1090, UNCOMPRESS=1091, UNCOMPRESSED_LENGTH=1092, UNHEX=1093, UNIX_TIMESTAMP=1094, 
		UPDATEXML=1095, UPPER=1096, UUID=1097, UUID_SHORT=1098, VALIDATE_PASSWORD_STRENGTH=1099, 
		VERSION=1100, WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS=1101, WEEKDAY=1102, WEEKOFYEAR=1103, 
		WEIGHT_STRING=1104, WITHIN=1105, YEARWEEK=1106, Y_FUNCTION=1107, X_FUNCTION=1108, 
		VAR_ASSIGN=1109, PLUS_ASSIGN=1110, MINUS_ASSIGN=1111, MULT_ASSIGN=1112, 
		DIV_ASSIGN=1113, MOD_ASSIGN=1114, AND_ASSIGN=1115, XOR_ASSIGN=1116, OR_ASSIGN=1117, 
		STAR=1118, DIVIDE=1119, MODULE=1120, PLUS=1121, MINUS=1122, DIV=1123, 
		MOD=1124, EQUAL_SYMBOL=1125, GREATER_SYMBOL=1126, LESS_SYMBOL=1127, EXCLAMATION_SYMBOL=1128, 
		BIT_NOT_OP=1129, BIT_OR_OP=1130, BIT_AND_OP=1131, BIT_XOR_OP=1132, DOT=1133, 
		LR_BRACKET=1134, RR_BRACKET=1135, COMMA=1136, SEMI=1137, AT_SIGN=1138, 
		ZERO_DECIMAL=1139, ONE_DECIMAL=1140, TWO_DECIMAL=1141, SINGLE_QUOTE_SYMB=1142, 
		DOUBLE_QUOTE_SYMB=1143, REVERSE_QUOTE_SYMB=1144, COLON_SYMB=1145, CHARSET_REVERSE_QOUTE_STRING=1146, 
		FILESIZE_LITERAL=1147, START_NATIONAL_STRING_LITERAL=1148, STRING_LITERAL=1149, 
		DECIMAL_LITERAL=1150, HEXADECIMAL_LITERAL=1151, REAL_LITERAL=1152, NULL_SPEC_LITERAL=1153, 
		BIT_STRING=1154, STRING_CHARSET_NAME=1155, DOT_ID=1156, ID=1157, REVERSE_QUOTE_ID=1158, 
		HOST_IP_ADDRESS=1159, LOCAL_ID=1160, GLOBAL_ID=1161, ERROR_RECONGNIGION=1162;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SPEL", "SPACE", "SPEC_MYSQL_COMMENT", "COMMENT_INPUT", "LINE_COMMENT", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "SPEL", "SPACE", "SPEC_MYSQL_COMMENT", "COMMENT_INPUT", "LINE_COMMENT", 
			"ADD", "ALL", "ALTER", "ALWAYS", "ANALYZE", "AND", "ARRAY", "AS", "ASC", 
			"ATTRIBUTE", "BEFORE", "BETWEEN", "BOTH", "BUCKETS", "BY", "CALL", "CASCADE", 
			"CASE", "CAST", "CHANGE", "CHARACTER", "CHECK", "COLLATE", "COLUMN", 
			"CONDITION", "CONSTRAINT", "CONTINUE", "CONVERT", "CREATE", "CROSS", 
