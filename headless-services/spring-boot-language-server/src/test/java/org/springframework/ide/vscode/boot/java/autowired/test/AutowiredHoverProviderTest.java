...
//					"@Component",
    ...
    @Test
    void javaxInjectAnnotationHover() throws Exception {
    ...
    @Test
    void noHoversWhenRunningAppDoesntHaveDependenciesForTheAutowiring() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("autowiredClass")
                        .type("com.example.AutowiredClass")
    ...
    @Test
    void bug_152553935() throws Exception {
    ...
    @Test
    void bug_152621242_autowired_constructor_on_a_controller() throws Exception {
    ...
    @Test
    void implicitAutowiringSingleConstructor() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
    ...
    @Test
    void noImplicitAutowiringForConstructorFromNonBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
    ...
    @Test
    void noImplicitAutowiringForMultipleConstructors() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void unableToMatchWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void qualifierParameterWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void qualifierFieldWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void qualifierNotFoundWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void qualifierWrongTypeWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void collectionWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void collectionWithQualifierWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void collectionOfCollectionsWiredBeanNotFound() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void collectionRawWithQualifierWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void arrayWithQualifierWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void arrayWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void arrayWiredBeans() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void multiDimensionalArrayWiredBean() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("someComponent")
                        .type("com.example.SomeComponent")
    ...
    @Test
    void anonymousInnerClassBeanWiring() throws Exception {
        LiveBeansModel beans = LiveBeansModel.builder()
                .add(LiveBean.builder()
                        .id("anotherComponent")
